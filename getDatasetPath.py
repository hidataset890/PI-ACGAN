...
def getDatasetPath(evalPath, dataset="PZ"):

    if dataset == "PZ":
        output_img_path = sorted(glob.glob("test_result/PZ/shadow_removal_image/ *.png"))
        gt_img_path = sorted(glob.glob("dataset/PZ/test/test_C/*.png"))
        mask_img_path = sorted(glob.glob("dataset/PZ/test/test_B/*.png"))
        ...
        if evalPath == "Guo" or evalPath == "ST-CGAN" or evalPath == "Gong" or evalPath == "Yang":
            ...
            output_img_path = sorted(glob.glob("dataset/ISTD/test/test_A/*.png"))
